...
**24 measured failures**, every one from a stamped artifact, classified against Barnett et al.'s seven failure points.
...
| **FP2** Missed Top Ranked | 15 | 62% | ██████████████████ |
| **FP3** Not In Context | 9 | 38% | ██████████ |
...
| `retrieval_miss_answered` | 6 | FP2 | the golden needle was not retrieved at this budget AND the model answered anyway -- from other context, so the answer may still be right; the measurement cannot tell |
...
**Retrieval, and specifically ranking within a document.** All 24 failures are FP2 or FP3 -- the evidence exists in the corpus and either was not retrieved or did not survive the budget fill.
